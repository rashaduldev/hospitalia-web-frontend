...
type Props = {
  ...
  locationId: number;
  locationName?: string;
  onAddSchedule?: (day: string) => void;
};

export default function SecretaryWeeklyScheduleOverview({
  doctorEntityId,
  lang,
  locationId,
  locationName,
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-border">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {locationName ? `${locationName} — ` : ""}Click a day to add or edit its schedule
            </p>
          </div>
        </div>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AppButton
              ...
              onClick={() => { if (slotToDelete) deleteMutation.mutate(slotToDelete.id); }}
            >
              Delete
            </AppButton>
          </AlertDialogFooter>
