    ...
    <header className="relative bg-back px-4 md:px-10 py-4 z-50">
      <div className="mx-auto flex items-center justify-between">
        ...
        <Link href={`/${locale}`} className="flex items-center">
          <Image src={siteConfig.logo} alt="Hospitalia logo" width={130} height={25} />
        </Link>
        ...
        >
          <span
            className={`h-0.5 w-6 bg-card-foreground transition-transform duration-300 ${
              isOpen ? "rotate-45 translate-y-2" : ""
            }`}
          />
          <span
            className={`h-0.5 w-6 bg-card-foreground transition-opacity duration-300 ${
