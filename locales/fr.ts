export default {
  ...
  banner: {
    ...
    titleSub: "Rationalisez le travail des prestataires de santé.",
    cardTitle: "Prendre un rendez-vous",
    cardSubtitle: "Heureux de vous revoir !",
    doctor: "Médecin",
    hospital: "Hôpital",
  ...
  whyChooseUs: {
    ...
    subtitle:
      "Fiable pour des milliers de personnes pour la qualité, l’expertise et les résultats.",
    stats: {
